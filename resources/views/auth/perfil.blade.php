...
<div class="container mx-auto p-6 flex justify-center bg-gray-200">
    <div class="bg-white shadow-xl rounded-xl p-8 w-full max-w-4xl">
        <div class="flex flex-col items-center space-y-6">
            <!-- Avatar -->
            <img id="perfilAvatar" src="/images/default-avatar.png" alt="Avatar" class="w-32 h-32 rounded-full border-4 border-purple-500 shadow-md">
        ...
        <div class="mt-6 flex justify-center">
            <button onclick="document.getElementById('modalPerfil').classList.remove('hidden')" class="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-semibold py-2 px-4 rounded-md shadow-md transition duration-300">
                Editar Perfil
            </button>
        </div>
    </div>
...
<div id="modalPerfil" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white rounded-lg w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 shadow-lg relative">
        ...
        <div class="flex justify-center mb-4">
            <img id="avatarPreview" src="/images/default-avatar.png" alt="Avatar" class="w-28 h-28 rounded-full border-4 border-purple-200 shadow-md object-cover ">
        </div>
        ...
        <form id="formActualizarPerfil" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                class="w-full px-4 py-2 rounded-md border border-purple-300 cursor-pointer text-gray-700 bg-purple-100 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 transition duration-300">
            </div>
            ...
            <div>
                ...
                <input id="inputNombre" name="name" type="text" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300 ease-in-out">
            </div>

            <!-- Apellido -->
            <div>
                <label class="block text-gray-700 text-sm font-medium mb-1">Apellido</label>
                <input id="inputApellido" name="lastname" type="text" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300 ease-in-out">
            </div>

            <!-- Username -->
            <div>
                <label class="block text-gray-700 text-sm font-medium mb-1">Nombre de usuario</label>
                <input id="inputUsername" name="username" type="text" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300 ease-in-out">
            </div>

            <!-- Biografía -->
            <div>
                <label class="block text-gray-700 text-sm font-medium mb-1">Biografía</label>
                <textarea id="inputBio" name="bio" rows="3" class="w-full p-2 rounded-md border border-gray-300 h-32 overflow-auto resize-none focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300 ease-in-out"></textarea>
            </div>

            <!-- Guardar -->
            <div class="flex justify-end">
                <button type="submit" class="bg-purple-600 hover:bg-puple-700 text-white px-4 py-2 rounded-md transition duration-300">
                    Guardar Cambios
                </button>
            </div>
        </form>
